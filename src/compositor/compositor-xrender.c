                            ...
                            Window          id)
{
  ...
  /* The extra 10 in these checks is to allow us to ignore changing tooltips
   * more than necessary.  I think GTK may be compensating towards the relevant
   * widget to account for some sort of margin.  If there's a tooltip we need to
   * fix we can be sure that it will be more than 10px outside of our workarea. */
